...
public class DoctorService implements Manageable<Doctor>, Searchable, Editable<Doctor> {
    ...
    public void validate(Doctor entity) {
        ...
        if(!HelperUtils.isValidString(entity.getAvailableSlots())|| entity.getAvailableSlots().isEmpty()){
            throw new IllegalArgumentException("Available Slots can't be empty");
        }
